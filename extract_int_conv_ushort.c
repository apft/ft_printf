...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/01/16 19:01:34 by apion             #+#    #+#             */
/*   Updated: 2019/01/16 19:22:05 by apion            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static unsigned int		get_size(unsigned short value, char *base)
{
	unsigned int	size;
	unsigned int	b;
...
unsigned int			extract_int_conv_ushort(va_list ap, t_specs *specs,
							char *base, char *str)
{
